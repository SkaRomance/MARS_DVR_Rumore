...
async def test_get_me_with_valid_token(
    client: AsyncClient, auth_headers, test_admin_user
):
...
@pytest.mark.asyncio
async def test_register_as_admin_same_tenant(
    client: AsyncClient, auth_headers, test_tenant
):
...
async def test_register_duplicate_email(
    client: AsyncClient, auth_headers, test_tenant, test_admin_user
):
    response = await client.post(
        f"{AUTH_PREFIX}/register",
        headers=auth_headers,
